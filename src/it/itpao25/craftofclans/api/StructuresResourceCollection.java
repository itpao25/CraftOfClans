...
public class StructuresResourceCollection extends PlayerEvent implements Cancellable {
	private StructuresId tipo;
	private VillageId village;
	private boolean cancelled = false;
	private static final HandlerList handlers = new HandlerList();

	public StructuresResourceCollection(StructuresId tipo, VillageId village, Player p) {
		super(p);
		this.tipo = tipo;
