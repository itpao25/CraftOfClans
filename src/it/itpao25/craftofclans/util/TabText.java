...
public class TabText {
	...
	/**
	 * set page height and get number of pages according to it, for later use with
	 * getPage()
	 * 
	...
	/**
	 * append chars with its width to be checked too, default width = 6 so you may
	 * only use for width != 6 chars
	 */
	 ...
	 * @param monospace true if fonts are fixed width (for server console) or false
	 *                  if variable with (for chat area)
	 ...
	 * @param mono true if lenght will be in chars (for console) or false if will be
	 *             in pixels (for chat area)
	 * @return object array with stripped string [0] and integer length in pixels or
	 *         chars depending of mono
	 */
	...
	/**
	 * sort lines by column values, string or numeric, IF SORT BY DECIMALS IT MUST
	 * HAVE SAME DECIMAL POSITIONS
	 * 
