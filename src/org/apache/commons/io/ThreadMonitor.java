 ...
 * <code>interrupt()</code> the <i>monitor</i> thread.
 * </p>
 * 
 * <pre>
...
class ThreadMonitor implements Runnable {
	 ...
	 *                is zero or less
	 * @return The monitor thread or {@code null} if the timeout amount is not
	 *         greater than zero
	 */
	...
	/**
	 * Sleep until the specified timeout amount and then interrupt the thread being
	 * monitored.
	 *
	 * @see Runnable#run()
	 */
	 ...
	 *
	 * This method exists because Thread.sleep(100) can sleep for 0, 70, 100 or
	 * 200ms or anything else it deems appropriate. Read the docs on Thread.sleep
