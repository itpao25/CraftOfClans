 ...
 * either in a case-sensitive, case-insensitive or system dependent case
...
public class PathFileComparator extends AbstractFileComparator implements Serializable {
	 ...
	 * @return a negative value if the first file's path is less than the second,
	 *         zero if the paths are the same and a positive value if the first
	 *         files path is greater than the second file.
	 * 
	 */
