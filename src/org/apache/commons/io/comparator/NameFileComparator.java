...
public class NameFileComparator extends AbstractFileComparator implements Serializable {
	 ...
	 * @return a negative value if the first file's name is less than the second,
	 *         zero if the names are the same and a positive value if the first
	 *         files name is greater than the second file.
	 */
