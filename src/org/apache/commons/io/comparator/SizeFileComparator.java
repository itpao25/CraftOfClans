 ...
 * <p>
 * This comparator can be used to sort lists or arrays of files by their
 * length/size.
 * <p>
 * Example of sorting a list of files using the {@link #SIZE_COMPARATOR}
 * singleton instance:
 * 
 * <pre>
 *       List&lt;File&gt; list = ...
...
public class SizeFileComparator extends AbstractFileComparator implements Serializable {
	 ...
	 * {@link FileUtils#sizeOfDirectory(File)}
	 */
	public static final Comparator<File> SIZE_SUMDIR_COMPARATOR = new SizeFileComparator(true);

	/**
	 * Reverse size comparator instance which sums the size of a directory's
	 * contents using {@link FileUtils#sizeOfDirectory(File)}
	 */
	...
	/**
	 * Construct a file size comparator instance specifying whether the size of the
	 * directory contents should be aggregated.
	 * <p>
	 ...
	 *
	 * @param sumDirectoryContents {@code true} if the sum of the directoryies
	 *                             contents should be calculated, otherwise
	 *                             {@code false} if directories should be treated as
	 *                             size zero (see
	 *                             {@link FileUtils#sizeOfDirectory(File)}).
	 */
	 ...
	 * @return a negative value if the first file's length is less than the second,
	 *         zero if the lengths are the same and a positive value if the first
	 *         files length is greater than the second file.
	 * 
	 */
