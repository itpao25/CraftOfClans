 ...
 * <p>
 *
 * @version $Id: LastModifiedFileComparator.java 1642757 2014-12-01 21:09:30Z
 *          sebb $
 * @since 1.4
 */
public class LastModifiedFileComparator extends AbstractFileComparator implements Serializable {
	 ...
	 * @return a negative value if the first file's lastmodified date/time is less
	 *         than the second, zero if the lastmodified date/time are the same and
	 *         a positive value if the first files lastmodified date/time is greater
