 ...
 * <p>
 * This comparator can be used to sort lists or arrays of files by their file
 * extension either in a case-sensitive, case-insensitive or system dependent
 * case sensitive way. A number of singleton instances are provided for the
 * various case sensitivity options (using {@link IOCase}) and the reverse of
 * those options.
 * <p>
...
public class ExtensionFileComparator extends AbstractFileComparator implements Serializable {
	...
	/**
	 * Construct a file extension comparator instance with the specified
	 * case-sensitivity.
	 *
	 ...
	 * @return a negative value if the first file's extension is less than the
	 *         second, zero if the extensions are the same and a positive value if
	 *         the first files extension is greater than the second file.
	 * 
	 */
