...
public class IOExceptionWithCause extends IOException {
	 ...
	 * @param cause   the cause (see {@link #getCause()}). A {@code null} value is
	 *                allowed.
	 */
	 ...
	 * which by default contains the class and message of <code>cause</code>. This
	 * constructor is useful for call sites that just wrap another throwable.
	 * </p>
	 * 
	 * @param cause the cause (see {@link #getCause()}). A {@code null} value is
	 *              allowed.
