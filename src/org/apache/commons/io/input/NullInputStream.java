 ...
 * <code>processBytes()</code> methods can be implemented to generate data, for
 * example:
 *
 * <pre>
...
public class NullInputStream extends InputStream {
	...
	/**
	 * Create an {@link InputStream} that emulates a specified size which supports
	 * marking and does not throw EOFException.
	 *
	 ...
	 * @return The number of bytes read or <code>-1</code> if the end of file has
	 *         been reached and <code>throwEofException</code> is set to
	 *         {@code false}.
	 * @throws EOFException if the end of file is reached and
	 *                      <code>throwEofException</code> is set to {@code true}.
	 * @throws IOException  if trying to read past the end of file.
	 ...
	 * @return The number of bytes skipped or <code>-1</code> if the end of file has
	 *         been reached and <code>throwEofException</code> is set to
	 *         {@code false}.
	 * @throws EOFException if the end of file is reached and
	 *                      <code>throwEofException</code> is set to {@code true}.
	...
	/**
	 * Process the bytes for the <code>read(byte[], offset, length)</code> method.
	 * <p>
