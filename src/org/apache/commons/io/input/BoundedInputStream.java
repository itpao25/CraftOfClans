...
public class BoundedInputStream extends InputStream {
	...
	/**
	 * Invokes the delegate's <code>read()</code> method if the current position is
	 * less than the limit.
	 * 
	 ...
	 * @return the number of bytes read or -1 if the end of stream or the limit has
	 *         been reached.
	 * @throws IOException if an I/O error occurs
	 */
	@Override
	 ...
	 *         <code>close()</code> method of the underlying stream or {@code false}
	 *         if it does not.
	 */
	 ...
	 * {@link InputStream}.
	 *
	 * @param propagateClose {@code true} if calling {@link #close()} propagates to
	 *                       the <code>close()</code> method of the underlying
	 *                       stream or {@code false} if it does not.
	 */
