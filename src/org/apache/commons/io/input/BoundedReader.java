 ...
 * from an underlying reader, returning eof when this limit is reached
 * -regardless of state of underlying reader.
 *
 * <p>
...
public class BoundedReader extends Reader {
	 ...
	 * @param maxCharsFromTargetReader The maximum number of characters that can be
	 *                                 read from target
	 ...
	 *
	 * @param readAheadLimit The number of characters that can be read while still
	 *                       retaining the ability to do #reset(). Note that this
	 *                       parameter is not validated with respect to
	 *                       maxCharsFromTargetReader. There is no way to pass past
	 *                       maxCharsFromTargetReader, even if this value is
	 *                       greater.
	 *
	 * @throws IOException If an I/O error occurs while calling the underlying
