 ...
 *
 * <p>
 * The file is read using the default charset; this can be overriden if
 * necessary
 * </p>
 * 
 * @see TailerListener
...
public class Tailer implements Runnable {
	...
	/**
	 * Creates a Tailer for the given file, starting from the beginning, with the
	 * default delay of 1.0s.
	 * 
	...
	/**
	 * Creates and starts a Tailer for the given file, starting at the beginning of
	 * the file
	 *
	 * @param file        the file to follow.
	 * @param listener    the TailerListener to use.
	...
	/**
	 * Creates and starts a Tailer for the given file, starting at the beginning of
	 * the file with the default delay of 1.0s
	 *
	 * @param file     the file to follow.
	 * @param listener the TailerListener to use.
	 * @return The new tailer
	...
	/**
	 * Follows changes in the file, calling the TailerListener's handle method for
	 * each new line.
	 */
	public void run() {
			...
			while (getRun()) {
				...
				if (length < position) {
					...
					if (length > position) {
						...
						/*
						 * This can happen if the file is truncated or overwritten with the exact same
						 * length of information. In cases like this, the file position needs to be
						 * reset
						 */
						position = 0;
