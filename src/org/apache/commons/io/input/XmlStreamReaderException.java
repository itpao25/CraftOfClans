 ...
 * already read.
 *
 * @version $Id: XmlStreamReaderException.java 1415850 2012-11-30 20:51:39Z
 *          ggregory $
 * @since 2.0
 */
public class XmlStreamReaderException extends IOException {
	 ...
	 * encoding.
	 *
	 * @return the MIME type in the content-type, null if there was not content-type
	 ...
	 * encoding.
	 *
	 * @return the encoding in the content-type, null if there was not content-type,
	 *         no encoding in it or the encoding detection did not involve HTTP.
	 */
