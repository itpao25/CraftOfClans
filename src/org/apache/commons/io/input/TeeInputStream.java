...
public class TeeInputStream extends ProxyInputStream {
	...
	/**
	 * The output stream that will receive a copy of all bytes read from the proxied
	 * input stream.
	 */
	 ...
	 * @param input       input stream to be proxied
	 * @param branch      output stream that will receive a copy of all bytes read
	 * @param closeBranch flag for closing also the output stream when this stream
	 *                    is closed
	 */
	...
	/**
	 * Closes the proxied input stream and, if so configured, the associated output
	 * stream. An exception thrown from one stream will not prevent closing of the
	 * other stream.
	 *
	...
	/**
	 * Reads bytes from the proxied input stream and writes the read bytes to the
	 * associated output stream.
	 *
