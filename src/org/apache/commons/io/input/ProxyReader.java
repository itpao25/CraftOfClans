 ...
 * <p>
 * It is an alternative base class to FilterReader to increase reusability,
 * because FilterReader changes the methods being called, such as read(char[])
...
public abstract class ProxyReader extends FilterReader {
	...
	/**
	 * Invoked by the read methods before the call is proxied. The number of chars
	 ...
	 * The number of chars returned to the caller (or -1 if the end of stream was
