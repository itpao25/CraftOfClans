...
public class CountingInputStream extends ProxyInputStream {
	 ...
	 * The number of bytes that have passed through this stream.
	 * <p>
	 * NOTE: This method is an alternative for <code>getCount()</code> and was added
	 * because that method returns an integer which will result in incorrect count
	 * for files over 2GB.
	 *
	 * @return the number of bytes accumulated
	 * @since 1.3
	 ...
	 * Set the byte count back to 0.
	 * <p>
	 * NOTE: This method is an alternative for <code>resetCount()</code> and was
	 * added because that method returns an integer which will result in incorrect
	 * count for files over 2GB.
	 *
	 * @return the count previous to resetting
	 * @since 1.3
	 */
