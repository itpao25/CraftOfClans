 ...
 *
 * @version $Id: DeferredFileOutputStream.java 1686747 2015-06-21 18:44:49Z
 *          krosenvold $
 */
public class DeferredFileOutputStream extends ThresholdingOutputStream {
	...
	/**
	 * The output stream to which data will be written at any given time. This will
	 * always be one of <code>memoryOutputStream</code> or
	...
	/**
	 * Switches the underlying output stream from a memory based stream to one that
	 * is backed by disk. This is the point at which we realise that too much data
	 * is being written to keep in memory, so we elect to switch to disk-based
	 * storage.
	 *
	 * @exception IOException if an error occurs.
	 */
	 ...
	 *
	 * @return The data for this output stream, or {@code null} if no such data is
	 *         available.
	 */
	public byte[] getData() {
	...
	/**
	 * Returns either the output file specified in the constructor or the temporary
	 ...
	 *
	 * @return The file for this output stream, or {@code null} if no such file
	 *         exists.
	 */
	public File getFile() {
		return outputFile;
