 ...
 *
 * @version $Id: ThresholdingOutputStream.java 1687815 2015-06-26 17:18:56Z
 *          krosenvold $
 */
public abstract class ThresholdingOutputStream extends OutputStream {
	 ...
	 * output stream.
	 *
	 * @return {@code true} if the threshold has been reached; {@code false}
	 *         otherwise.
	 */
	...
	/**
	 * Sets the byteCount to count. Usefull for re-opening an output stream that
	 * been previously written to.
	 *
	 * @param count The number of bytes that have already been written to the output
	 *              stream
	 *
	 * @since 2.5
	 */
	 ...
	 * should take whatever action necessary on this event. This may include
	 * changing the underlying output stream.
	 *
	 * @exception IOException if an error occurs.
	 */
