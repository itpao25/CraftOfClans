...
/**
 * FileWriter that will create and honor lock files to allow simple cross thread
 * file lock handling.
 * <p>
 * This class provides a simple alternative to <code>FileWriter</code> that will
 * use a lock file to prevent duplicate writes.
 * <p>
 * <b>N.B.</b> the lock file is deleted when {@link #close()} is called - or if
 * the main file cannot be opened initially. In the (unlikely) event that the
 * lockfile cannot be deleted, this is not reported, and subsequent requests
 * using the same lockfile will fail.
 * <p>
 * By default, the file will be overwritten, but this may be changed to append.
 * The lock directory may be specified, but defaults to the system property
 * <code>java.io.tmpdir</code>. The encoding may also be specified, and defaults
 * to the platform default.
 *
 * @version $Id: LockableFileWriter.java 1686747 2015-06-21 18:44:49Z krosenvold
 *          $
 */
public class LockableFileWriter extends Writer {
	 ...
	 * @throws IOException          in case of an I/O error
	 * @deprecated 2.5 use
	 *             {@link #LockableFileWriter(File, Charset, boolean, String)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Initialise the wrapped file writer. Ensure that a cleanup occurs if the
