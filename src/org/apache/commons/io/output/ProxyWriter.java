 ...
 * is an alternative base class to FilterWriter to increase reusability, because
 * FilterWriter changes the methods being called, such as write(char[]) to
 * write(char[], int, int) and write(String) to write(String, int, int).
 * 
 * @version $Id: ProxyWriter.java 1415850 2012-11-30 20:51:39Z ggregory $
 */
public class ProxyWriter extends FilterWriter {
	...
	/**
	 * Invoked by the write methods before the call is proxied. The number of chars
	 * to be written (1 for the {@link #write(int)} method, buffer length for
	 * {@link #write(char[])}, etc.) is given as an argument.
	 * <p>
	 ...
	 * successfully. The number of chars written (1 for the {@link #write(int)}
	 * method, buffer length for {@link #write(char[])}, etc.) is given as an
	 * argument.
	 * <p>
