 ...
 * {@link java.io.ByteArrayOutputStream} class. The original implementation only
 ...
 * only exception is the deprecated toString(int) method that has been ignored.
 *
 * @version $Id: ByteArrayOutputStream.java 1612034 2014-07-20 06:35:19Z
 *          ggregory $
 */
public class ByteArrayOutputStream extends OutputStream {
	 ...
	 *                     it has to now due to backwards compatibility)
	 */
	@Override
	...
	public static InputStream toBufferedInputStream(final InputStream input, int size) throws IOException {
		// It does not matter if a ByteArrayOutputStream is not closed as close() is a
		// no-op
	...
	/**
	 * Gets the curent contents of this byte stream as a string using the platform
	 * default charset.
	 * 
