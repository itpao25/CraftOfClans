...
public class IOUtils {
	 ...
	 * </ul>
	 * It can be used in favor of {@link #toByteArray(InputStream)}, since it avoids
	...
	/**
	 * Gets the contents of a <code>Reader</code> as a <code>byte[]</code> using the
	...
	/**
	 * Gets the contents of a <code>String</code> as a <code>byte[]</code> using the
	 * default character encoding of the platform.
	 * <p>
	...
	/**
	 * Gets the contents of an <code>InputStream</code> as a character array using
	...
	/**
	 * Gets the contents of a <code>byte[]</code> as a String using the default
	...
	/**
	 * Gets the contents of a <code>byte[]</code> as a String using the specified
	 * character encoding.
	 * <p>
	 * Character encoding names can be found at
	 * <a href="http://www.iana.org/assignments/character-sets">IANA</a>.
	...
	/**
	 * Gets the contents of an <code>InputStream</code> as a list of Strings, one
	...
	/**
	 * Gets the contents of a <code>Reader</code> as a list of Strings, one entry
	 * per line.
	 * <p>
	 * This method buffers the input internally, so there is no need to use a
	 * <code>BufferedReader</code>.
	 ...
	 * directly, or by calling {@link LineIterator#close()} or
	...
	/**
	 * Returns an Iterator for the lines in an <code>InputStream</code>, using the
	 ...
	 * @throws IOException              if an I/O error occurs, such as if the
	 *                                  encoding is invalid
	 * @since 2.3
	 */
	 ...
	 * @param encoding the encoding to use, null means platform default
	 * @return an input stream
	 * @throws IOException                                  if the encoding is
	 *                                                      invalid
	 * @throws java.nio.charset.UnsupportedCharsetException thrown instead of
	 *                                                      {@link java.io .UnsupportedEncodingException}
	 *                                                      in version 2.2 if the
	 ...
	 * @since 1.1
	 * @deprecated 2.5 use
	 *             {@link #writeLines(Collection, String, OutputStream, Charset)}
	 *             instead
	 */
	@Deprecated
