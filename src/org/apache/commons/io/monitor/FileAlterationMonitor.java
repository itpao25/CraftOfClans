 ...
 * @version $Id: FileAlterationMonitor.java 1415850 2012-11-30 20:51:39Z
 *          ggregory $
 * @since 2.0
 */
public final class FileAlterationMonitor implements Runnable {
	 ...
	 *
	 * @param interval The amount of time in miliseconds to wait between checks of
	 *                 the file system
	 */
	 ...
	 * Stop monitoring.
	 *
	 * @param stopInterval the amount of time in milliseconds to wait for the thread
	 *                     to finish. A value of zero will wait until the thread is
	 *                     finished (see {@link Thread#join(long)}).
	 * @throws Exception if an error occurs initializing the observer
	 * @since 2.1
	 */
