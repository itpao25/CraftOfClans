 ...
 * checking the filesystem and notifying listeners of create, change or delete
 * events.
 * <p>
 * To use this implementation:
 * <ul>
 * <li>Create {@link FileAlterationListener} implementation(s) that process the
 * file/directory create, change and delete events</li>
 * <li>Register the listener(s) with a {@link FileAlterationObserver} for the
 * appropriate directory.</li>
 ...
 * system by using {@link FileFilter}s to observe only the files and/or
 * directories that are of interest. This makes it more efficient and reduces
 * the noise from <i>unwanted</i> file system events.
 * <p>
 * <a href="http://commons.apache.org/io/">Commons IO</a> has a good range of
 * useful, ready made <a href="../filefilter/package-summary.html">File
 * Filter</a> implementations for this purpose.
 * <p>
 ...
 * </pre>
 *
 * <h2>FileEntry</h2> {@link FileEntry} represents the state of a file or
 * directory, capturing {@link File} attributes at a point in time. Custom
 ...
 * directory has changed since the last check and stores the current state of
 * the {@link File}'s properties.
 *
 * @see FileAlterationListener
 * @see FileAlterationMonitor
 * @version $Id: FileAlterationObserver.java 1686747 2015-06-21 18:44:49Z
 *          krosenvold $
 * @since 2.0
 */
public class FileAlterationObserver implements Serializable {
	...
	/**
	 * Construct an observer for the specified directory, file filter and file
	 * comparator.
	 *
	 * @param directoryName   the name of the directory to observe
	 * @param fileFilter      The file filter or null if none
	 * @param caseSensitivity what case sensitivity to use comparing file names,
	...
	/**
	 * Compare two file lists for files which have been created, modified or
	 * deleted.
	 *
	 ...
	 * @return the directory contents or a zero length array if the empty or the
