...
/**
 * The state of a file or directory, capturing the following {@link File}
 ...
 * <p>
 * If the state of additional {@link File} attributes is required then create a
 * custom {@link FileEntry} with properties for those attributes. Override the
 * {@link #newChildInstance(File)} to return a new instance of the appropriate
 * type. You may also want to override the {@link #refresh(File)} method.
 * </p>
 * 
...
public class FileEntry implements Serializable {
	...
	/**
	 * Refresh the attributes from the {@link File}, indicating whether the file has
	 * changed.
	 * <p>
	 ...
	 * <p>
	 * Custom implementations should override this method to return a new instance
	 ...
	 *
	 * @return This directory's files or an empty array if the file is not a
