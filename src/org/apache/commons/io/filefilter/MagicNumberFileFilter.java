 ...
 * a unique series of bytes common to all files of a specific file format. For
 * instance, all Java class files begin with the bytes <code>0xCAFEBABE</code>.
 * </p>
 *
 * <pre>
 * File dir = new File(".");
 ...
 *
 * <p>
 * Sometimes, such as in the case of TAR files, the magic number will be offset
 * by a certain number of bytes in the file. In the case of TAR archive files,
 * this offset is 257 bytes.
 * </p>
 *
 * <pre>
 * File dir = new File(".");
...
public class MagicNumberFileFilter extends AbstractFileFilter implements Serializable {
	...
	/**
	 * The offset (in bytes) within the files that the magic number's bytes should
	 * appear.
	 */
	 ...
	 * number to test for in files. This constructor assumes a starting offset of
	 * <code>0</code>.
	 * </p>
	 *
	 * <p>
	 * It is important to note that <em>the array is not cloned</em> and that any
	 * changes to the magic number array after construction will affect the behavior
	 * of this file filter.
	 * </p>
	 *
	 * <pre>
	 ...
	 * </pre>
	 *
	 * @param magicNumber the magic number to look for in the file. The string is
	 *                    converted to bytes using the platform default charset.
	 *
	 * @throws IllegalArgumentException if <code>magicNumber</code> is {@code null}
	 *                                  or the empty String.
	 */
	 ...
	 * <p>
	 * Constructs a new MagicNumberFileFilter and associates it with the magic
	 * number to test for in files and the byte offset location in the file to to
	 ...
	 *
	 * @throws IllegalArgumentException if <code>magicNumber</code> is {@code null}
	 *                                  or the empty String, or <code>offset</code>
	...
	/**
	 * <p>
	 * Accepts the provided file if the file contains the file filter's magic number
	 * at the specified offset.
	 * </p>
	 *
	 * <p>
	 * If any {@link IOException}s occur while reading the file, the file will be
	 * rejected.
	 * </p>
	 *
	 * @param file the file to accept or reject.
	 *
	 * @return {@code true} if the file contains the filter's magic number at the
	...
	/**
	 * Returns a String representation of the file filter, which includes the magic
	 * number bytes and byte offset.
	 *
