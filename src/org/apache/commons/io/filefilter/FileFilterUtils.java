...
public class FileFilterUtils {
	 ...
	 * @throws IllegalArgumentException if the filter is {@code null} or
	 *                                  <code>files</code> contains a {@code null}
	 *                                  value.
	 *
	 * @since 2.0
	 */
	 ...
	 * <p>
	 * Applies an {@link IOFileFilter} to the provided {@link File} objects. The
	 * resulting list is a subset of the original files that matches the provided
	 * filter.
	 * </p>
	 *
	 * <p>
	 ...
	 * <p>
	 * Applies an {@link IOFileFilter} to the provided {@link File} objects. The
	 * resulting set is a subset of the original file list that matches the provided
	 * filter.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * Returns a filter that returns true if the filename starts with the specified
	 * text.
	 *
	...
	/**
	 * Returns a filter that returns true if the filename ends with the specified
	 * text.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException if the filters are null or contain a null
	 *                                  value.
	 * @see AndFileFilter
	 * @since 2.0
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns an <code>IOFileFilter</code> that wraps the <code>FileFilter</code>
	 * instance.
	 *
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a filter that returns true if the file was last modified after the
	 ...
	 * number.
	 *
	 * @param magicNumber the magic number (byte sequence) to match at the beginning
	 *                    of each file.
	 *
	 * @return an IOFileFilter that accepts files beginning with the provided magic
	 *         number.
	 *
	 * @throws IllegalArgumentException if <code>magicNumber</code> is {@code null}
	 *                                  or the empty String.
	 ...
	 * at a specified offset within the file.
	 *
	 * @param magicNumber the magic number (byte sequence) to match at the provided
	 *                    offset in each file.
	 * @param offset      the offset within the files to look for the magic number.
	 *
	 * @return an IOFileFilter that accepts files containing the magic number at the
	 *         specified offset.
	 *
	 * @throws IllegalArgumentException if <code>magicNumber</code> is {@code null}
	 ...
	 *
	 * @throws IllegalArgumentException if <code>magicNumber</code> is {@code null},
	 *                                  or contains no bytes, or <code>offset</code>
	...
	/**
	 * Decorates a filter to make it ignore CVS directories. Passing in {@code null}
	 * will return a filter that accepts everything except CVS directories.
	 *
	...
	/**
	 * Decorates a filter to make it ignore SVN directories. Passing in {@code null}
	 * will return a filter that accepts everything except SVN directories.
	 *
	 * @param filter the filter to decorate, null means an unrestricted filter
	 * @return the decorated filter, never null
	 * @since 1.1
